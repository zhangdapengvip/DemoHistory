...
import com.zero.library.base.bean.AdvertInfo;
...
public class AutoScrollViewPager extends RelativeLayout {
    ...
    public AutoScrollViewPager(Context context, AttributeSet attrs) {
        ...
        TypedArray mTypeArray = context.obtainStyledAttributes(attrs,
                R.styleable.HorizontlScrollViewPager);
        mContinuedTime = mTypeArray.getInteger(
                R.styleable.HorizontlScrollViewPager_scrollDurationMinute,
                DEFAULT_TIME);
        mAllowScroll = mTypeArray
                .getBoolean(R.styleable.HorizontlScrollViewPager_allowScroll,
                        DEFAULT_ALLOW);
    ...
    public void setDatas(List<AdvertInfo> dataLists) {
    ...
    private class MyAdapter extends DefaultPagerAdapter<AdvertInfo> {

        public MyAdapter(List<AdvertInfo> dataList, int count) {
            super(dataList, count);
        }

        @Override
        protected View initItemView(AdvertInfo advertInfo, int position) {
            ...
            UtilsPicasso.loadImage(mContext, advertInfo.getPicture(), R.drawable.bg_horizontal_default, mImageContext);
            return mPagerItem;
        }
