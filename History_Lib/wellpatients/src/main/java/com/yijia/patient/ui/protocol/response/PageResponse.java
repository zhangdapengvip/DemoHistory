 ...
 * 科研参与
 */
public class PageResponse extends DefaultResponse {
    private Page page;
    ...
    public class Page {
        ...
        public class Rows implements Serializable {
            private static final long serialVersionUID = 557064900551347552L;

            private String ispass;//是否通过 0未通过1通过
            private String pkResearchproject;//科研主键
