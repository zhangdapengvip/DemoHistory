...
import com.yijia.zkl.ui.activity.FamousDetailActivity;
 ...
 * 名医榜
 */
public class FamousListFragment extends TongBaseFragment {
    private String SAVE_KEY = "FamousListFragment";
    ...
    public String getPagerTitle() {
        return UtilsUi.getString(R.string.label_famous_list_name);
    }
    ...
    protected DefaultAdapter getAdapter(ListView listView) {
        return new DefaultAdapter<OnlineqaPageResponse.Page.Rows>(mActivity,
            ...
            public void onItemClickInner(int position) {
                ...
                Intent intent = new Intent(mActivity, FamousDetailActivity.class);
    ...
    private void loadList() {
        ...
        request.setType(OnlineqaPageRequest.TYPE_HISTORY);
