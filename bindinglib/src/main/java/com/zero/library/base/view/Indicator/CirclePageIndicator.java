package com.zero.library.base.view.Indicator;
...
public class CirclePageIndicator extends View implements PageIndicator {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        final int realCount = mPageCount == -1 ? count : mPageCount;
        if (count == 0) {
            return;
        }
        ...
        float cx = (mSnap ? mSnapPage % mPageCount : mCurrentPage % mPageCount) * threeRadius;
        if (!mSnap) {
