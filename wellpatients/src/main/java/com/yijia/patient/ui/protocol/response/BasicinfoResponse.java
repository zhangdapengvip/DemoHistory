 ...
 * 基本信息
 */
public class BasicinfoResponse extends DefaultResponse {


    private Basicinfo datas = new Basicinfo();

    public Basicinfo getDatas() {
        return datas;
    }

    public void setDatas(Basicinfo datas) {
        this.datas = datas;
    }
