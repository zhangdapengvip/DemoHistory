...
public class HeaderLoadingLayout extends LoadingLayout {
    ...
    public void setLastUpdatedLabel(CharSequence label) {
        mHeaderTimeViewTitle.setVisibility(TextUtils.isEmpty(label) ? View.INVISIBLE : View
                .VISIBLE);
    ...
    protected View createLoadingView(Context context, AttributeSet attrs) {
        View container = LayoutInflater.from(context).inflate(R.layout.wgt_pull_refresh_header,
                null);
        return container;
    }
