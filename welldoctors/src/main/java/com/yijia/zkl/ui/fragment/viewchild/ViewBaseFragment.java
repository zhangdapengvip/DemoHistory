...
import com.yijia.zkl.ui.activity.ViewDetailActivity;
import com.yijia.zkl.ui.bean.Constants;
import com.yijia.zkl.ui.bean.OfficeInfo;
import com.yijia.zkl.ui.holder.ViewNewsHolder;
...
public abstract class ViewBaseFragment extends ListBaseFragment {
    ...
    private void loadList() {
        ...
        if (mPageNum == AppConstants.FIRST_NUM) {
            ViewPageResponse response = UtilsGson.fromJson(getSaveInfo(SAVE_KEY + mDomain), ViewPageResponse.class);
